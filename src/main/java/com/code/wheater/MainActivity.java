...
public class MainActivity extends AppCompatActivity {
    final String APP_ID = "9d115f03fdccc4143b6370d348f5a051";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mwheatherIcon = findViewById(R.id.icons);
...
*/
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationManger.requestLocationUpdates(Location_Provider,
                MIN_TIME,
                MIN_DISTANCE,
                mLocationListener);
...
private void updateUI(weatherData weather){
        ...
        mwheatherIcon.setImageResource(resourceId);
